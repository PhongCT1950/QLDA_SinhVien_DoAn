...
{
    public partial class OldfrmDiemDoAn: Form
    {
        DiemService diemService = new DiemService();
        public OldfrmDiemDoAn()
        {
            InitializeComponent();
        }
        ...
        public void loadListDiemDoAn()
        {
            ...
            dtgv_diemDoAn.Columns["MADA"].HeaderText = "Mã DA";
            dtgv_diemDoAn.Columns["MANHOM"].HeaderText = "Mã Nhóm";
            dtgv_diemDoAn.Columns["TENDA"].HeaderText = "Tên DA";
